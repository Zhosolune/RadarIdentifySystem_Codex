...
if __name__ == "__main__":
    tests = [
        test_filter_defaults_to_dash_when_unbound,
        test_filter_picks_up_bound_context,
        test_explicit_extra_overrides_context,
        test_unbind_restores_previous_value,
        test_nested_bindings_restore_in_order,
    ]
    for test in tests:
        test()
